...
<head>
    ...
    <title>Lending Tree - Responsive HTML5 Template</title>
    <!-- web-fonts -->
...
<nav class="navbar m-menu navbar-default">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="index.html"><img src="img/lendingtreelogo1.png" alt=""></a>
        </div>
        ...
        <div class="collapse navbar-collapse" id="#navbar-collapse-1">
            <ul class="nav navbar-nav navbar-right main-nav">
                ...
                <li><a href="customer_home">Customer</a></li>
				<li><a href="pickup_home">Pickup</a></li>
				<li><a href="verification_home">Verification</a></li>
                <li><a href="legal_home">Legal</a></li>
...
<footer class="footer">
    ...
    <div class="copyright-section">
        <div class="container clearfix">
             <span class="copytext">Copyright &copy; 2016 | <a href="https://uicookies.com/downloads/marketer-bootstrap-html5-advertising-agency-website-template/">Lending Tree</a> Designed And Developed By: <strong style="color:#4d6de3">uiCookies.com</strong></span>

...
<div class="container">
              ...
              <div class="panel-heading">
                <div class="row">
                  ...
                  <spring:url value="/admin/addAdmin/" var="addURL" />
                    <a type="button" class="btn btn-sm btn-primary btn-create"  href="${addURL }">Create New Admin</a>
                  </div>
                </div>
              </div>
    ...
    <c:forEach items="${adminList}" var="admin" >
     ...
     <td>${admin.pwd}</td>
      ...
      <td>
       <spring:url value="/admin/updateAdmin/${admin.id }" var="updateURL" />
       <a class="btn btn-primary" href="${updateURL}" role="button" >Update</a>
      </td>
      <td>
       <spring:url value="/admin/deleteAdmin/${admin.id}" var="deleteURL" />

...
<div class="container">
              ...
              <div class="panel-heading">
                <div class="row">
                  <div class="col col-xs-6">
                    <h3 class="panel-title">Bank List</h3>
                  </div>
                  <div class="col col-xs-6 text-right">
                  <spring:url value="/bank/addBank/" var="addURL" />
                    <a type="button" class="btn btn-sm btn-primary btn-create"  href="${addURL }">Create New Bank</a>
                  </div>
                </div>
              </div>
    ...
    <c:forEach items="${bankList}" var="bank" >
     <tr>
      ...
      <td>
       <spring:url value="/bank/updateBank/${bank.bankid }" var="updateURL" />
       <a class="btn btn-primary" href="${updateURL}" role="button" >Update</a>
      </td>
      <td>
       <spring:url value="/bank/deleteBank/${bank.bankid}" var="deleteURL" />
